        ...
        <div class="login-card">
            ...
            @if($otpExpired)
                <div class="alert alert-warning" style="margin-bottom:1rem;">
                    <span>⚠️</span>
                    <span>انتهت صلاحية رمز التحقق. <a href="{{ route('admin.forgot-password.form') }}" style="color:var(--primary);font-weight:700;">أعد إرسال الطلب</a></span>
                </div>
            @endif

            <form method="post" action="{{ route('admin.forgot-password.verify') }}" class="login-form">
                @csrf
            ...
            <div class="login-footer">
                <a href="{{ route('admin.forgot-password.form') }}" class="btn btn-ghost" style="width:100%;">← إعادة إرسال الرمز</a>
            </div>
        </div>
    </div>
@endsection
